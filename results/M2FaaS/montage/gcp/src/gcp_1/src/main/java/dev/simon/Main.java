...
public class Main implements com.google.cloud.functions.HttpFunction {
    ...
    public void service(final com.google.cloud.functions.HttpRequest request, final com.google.cloud.functions.HttpResponse response) throws java.io.IOException {
        ...
        java.util.List<dev.simon.model.ProjectPair> projectPairs = gson.fromJson(input.get("projectPairs"), new com.google.gson.reflect.TypeToken<java.util.List<dev.simon.model.ProjectPair>>(){}.getType());
        ...
        java.lang.String workingDir = gson.fromJson(input.get("workingDir"), new com.google.gson.reflect.TypeToken<java.lang.String>(){}.getType());
        ...
        for (dev.simon.model.ProjectPair pair : projectPairs) {
            directoryMonitor.startMonitoring();
            montage.mProjectPP(java.util.List.of("-X"), pair, regionHdr);
            directoryMonitor.stopMonitoring(pair);
        }
