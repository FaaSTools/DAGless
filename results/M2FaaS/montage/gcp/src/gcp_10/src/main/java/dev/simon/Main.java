...
public class Main implements com.google.cloud.functions.HttpFunction {
    ...
    public void service(final com.google.cloud.functions.HttpRequest request, final com.google.cloud.functions.HttpResponse response) throws java.io.IOException {
        ...
        java.lang.String mosaicFits = gson.fromJson(input.get("mosaicFits"), new com.google.gson.reflect.TypeToken<java.lang.String>(){}.getType());
        ...
        montage.mAdd(java.util.List.of(), cImagesTbl, regionHdr, mosaicFits);
        // mShrink
        ...
        output.put("mosaicFits", mosaicFits);
        output.put("mosaicShrinked", mosaicShrinked);
