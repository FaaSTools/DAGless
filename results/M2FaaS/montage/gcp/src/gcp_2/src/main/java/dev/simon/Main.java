...
public class Main implements com.google.cloud.functions.HttpFunction {
    ...
    public void service(final com.google.cloud.functions.HttpRequest request, final com.google.cloud.functions.HttpResponse response) throws java.io.IOException {
        ...
        java.lang.String imageList = java.nio.file.Path.of(workingDir, "input.imglist").toString();
        montage.mImgtbl(java.util.List.of("-t" + imageList), inputDir, imagesTbl);
        // mDAGTbls
        ...
        // combined prepareMDiffFit
        // skipped due to ridiculous amount parameters to pass
        // mDiffFit
        // create DiffPairs
